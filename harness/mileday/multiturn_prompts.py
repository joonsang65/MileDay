...
API_MULTITURN_PROMPT_VERSION = "v12-api"
...
PROMPT_VERSION_HISTORY = {
    ...
    "v12-api": "API 모델 전용 프롬프트. 부분수정 scope를 단일/요일/평일/주말/전체 재정리로 분리해 target 선택을 강화한 버전.",
}

def build_mileday_multiturn_api_prompt(
    ...
    return (
        ...
        f"prompt_version: {API_MULTITURN_PROMPT_VERSION}\n\n"
        "[REFERENCE_DATE]\n"
