...
@router.get(
    ...
    description="goal_id에 해당하는 목표의 하위 마일스톤 목록 조회",
)
...
@router.post(
    ...
    description="goal_id에 해당하는 목표의 새 마일스톤 생성",
)
...
@router.get(
    ...
    response_model=MilestoneListResponse,
    summary="오늘 할 일 조회",
    description="오늘 수행 예정 마일스톤 목록 조회",
)
...
@router.get(
    ...
    response_model=MilestoneResponse,
    summary="마일스톤 상세 조회",
    description="milestone_id에 해당하는 특정 마일스톤의 상세 정보 조회",
)
def get_milestone(
...
@router.patch(
    ...
    response_model=MilestoneResponse,
    summary="마일스톤 수정",
    description="마일스톤의 제목, 색상, 수행일, 완료 여부 수정",
)
...
@router.delete(
    ...
    summary="마일스톤 삭제",
    description="milestone_id에 해당하는 마일스톤 삭제",
)
...
@router.patch(
    ...
    response_model=MilestoneResponse,
    summary="마일스톤 완료 처리",
    description="milestone_id에 해당하는 마일스톤의 완료 여부 변경",
)
